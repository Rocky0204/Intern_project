...
def test_delete_operator_with_dependencies(client, db_session):
    ...
    garage = Garage(garage_id=2, name="Test Garage", capacity=10, latitude=0, longitude=0)
    ...
    assert any(word in error_detail for word in ["associated", "buses", "routes", "services"])