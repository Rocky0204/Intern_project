...
from ..schemas import EmulatorLogCreate, EmulatorLogRead, EmulatorLogUpdate, RunStatus
...
def create_emulator_log(
    emulator_log: EmulatorLogCreate, 
...
def update_emulator_log(
    run_id: int, 
    emulator_log: EmulatorLogUpdate, 
    db: Session = Depends(get_db)
) -> EmulatorLogRead:
    """
